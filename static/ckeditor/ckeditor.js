...
(function() {
        ...
        return {
            ...
            on: function(b, d, g, k, l) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    q.fn = d;
                    q.priority = l;
                    for (var A = f.length - 1; 0 <= A; A--) if (f[A].priority <= l) return f.splice(A + 1, 0, q),
                    {
                        removeListener: v
                    };
                    f.unshift(q)
                ...
                return function(l, q, v) {
                    ...
                    if (f) {
                        ...
                        if (A.length) for (var A = A.slice(0), r, D = 0; D < A.length; D++) {
                            if (f.errorProof) try {
                                r = A[D].call(this, v, q, b, k)
                            } catch(n) {} else r = A[D].call(this, v, q, b, k); ! 1 === r ? g = 1 : "undefined" != typeof r && (q = r);
                            if (a || g) break
                        }
                    }
    ...
    CKEDITOR.dom = {}; (function() {
        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function(a) {
                a = [].concat(a);
                for (var f, b = [], c = 0; c < a.length; c++) if (f = a[c]) / @import | [{}] / .test(f) ? b.push("\x3cstyle\x3e" + f + "\x3c/style\x3e") : b.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + f + '"\x3e');
                return b.join("")
            },
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                c = c.replace(/\n/g, "\x3cbr\x3e");
                b || (c = c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + l + "\x3e)"),
                function(a) {
            ...
            getUniqueId: function() {
                for (var a = "e",
                f = 0; 8 > f; f++) a += Math.floor(65536 * (1 + Math.random())).toString(16).substring(1);
                return a
            },
            ...
            indexOf: function(a, f) {
                if ("function" == typeof f) for (var b = 0,
                c = a.length; b < c; b++) {
                    if (f(a[b])) return b
                } else {
            ...
            normalizeCssText: function(a, b) {
                var c = [],
                l,
                d = CKEDITOR.tools.parseCssText(a, !0, b);
            ...
            enableHtml5Elements: function(a, b) {
                for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), l = c.length, d; l--;) d = a.createElement(c[l]),
                b && a.appendChild(d)
            },
            checkIfAnyArrayItemMatches: function(a, b) {
                for (var c = 0,
                l = a.length; c < l; ++c) if (a[c].match(b)) return ! 0;
                return ! 1
            },
    ...
    CKEDITOR.dom.element.clearMarkers = function(a, d, b) {
        ...
        function c(a) {
            for (var b = 0,
            c = 0,
            f = k[a].length; c < f; c++) b += parseInt(this.getComputedStyle(k[a][c]) || 0, 10) || 0;
            return b
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            breakParent: function(a, b) {
                ...
                if (CKEDITOR.env.ie && !CKEDITOR.env.edge) {
                    for (c = new CKEDITOR.dom.element("div"); d = f.getFirst();) d.$.style.backgroundColor && (d.$.style.backgroundColor = d.$.style.backgroundColor),
                    c.append(d);
                    c.insertAfter(this);
                    c.remove(!0)
            ...
            unselectable: function() {
                ...
                if (CKEDITOR.env.ie) {
                    ...
                    for (var a, b = this.getElementsByTag("*"), c = 0, f = b.count(); c < f; c++) a = b.getItem(c),
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version: 1)) {
                    ...
                    g = f.$.documentElement,
                    n = g.clientTop || d.$.clientTop || 0,
                    w = g.clientLeft || d.$.clientLeft || 0,
                    k = !0;
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                d = d.y + t + w(this, "bottom") - (u.y + h) || 0; (0 > r || 0 < d) && g(0, !0 === b ? r: !1 === b ? d: 0 > r ? r: d);
            ...
            copyAttributes: function(a, b) {
                ...
                for (var f = 0; f < c.length; f++) {
                    ...
                    r;
                    if (! (e in b)) if ("checked" == e && (r = this.getAttribute(e))) a.setAttribute(e, r);
                    else if (!CKEDITOR.env.ie || this.hasAttribute(e)) r = this.getAttribute(e),
                    null === r && (r = d.nodeValue),
                    a.setAttribute(e, r)
                }
            ...
            forEach: function(a, b, c) {
                ...
                if (!1 !== f) {
                    c = this.getChildren();
                    for (var d = 0; d < c.count(); d++) f = c.getItem(d),
    ...
    !0, {
        ...
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                var x = f.type == CKEDITOR.NODE_ELEMENT ? f: f.getParent(),
                z = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(y) : f.getNext();
            ...
            this.current ? f = this.current[m](!1, p, t) : (a ? f.type == CKEDITOR.NODE_ELEMENT && (f = 0 < y ? f.getChild(y - 1) : !1 === t(f, !0) ? null: f.getPreviousSourceNode(!0, p, t)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === t(d, !0) ? null: d.getNextSourceNode(!0, p, t)))), f && !1 === t(f) && (f = null));
            for (; f && !this._.end;) {
                this.current = f;
        ...
        CKEDITOR.dom.walker.empty = function(a) {
            return function(b) {
                for (var c = 0,
                f = b.getChildCount(); c < f; ++c) if (!v(b.getChild(c))) return !! a;
                return ! a
            }
        };
        ...
        CKEDITOR.dom.walker.editable = function(a) {
            return function(b) {
                b = v(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(y) && f(b)) ? !0 : !1;
                return !! (a ^ b)
            }
        };
    ...
    CKEDITOR.dom.range = function(a) {
        ...
        function d(a, b, c, d, e) {
            ...
            function k() {
                var b = I - 1,
                c = E && v && !p.equals(m);
                b < G - 1 || b < K - 1 || c ? (c ? a.moveToPosition(m, CKEDITOR.POSITION_BEFORE_START) : K == b + 1 && B ? a.moveToPosition(C[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(C[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = N[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({
                    startNode: c
                }))) : a.collapse(!0)
            }
            a.optimizeBookmark();
            ...
            z = a.endOffset,
            F, B, E, v, q, O;
            if (h && m.type == CKEDITOR.NODE_TEXT && p.equals(m)) p = a.document.createText(p.substring(x, z)),
            c.append(p);
            else {
                ...
                J = c;
                for (Q = I; Q <= K; Q++) if (c = C[Q], U = c.getPrevious(), c.equals(N[Q])) b && (J = J.getChild(0));
                else {
        ...
        function e(a) {
            return function() {
                var b;
                return this[a ? "getPreviousNode": "getNextNode"](function(a) { ! b && v(a) && (b = a);
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark: function(a) {
                ...
                n || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), e = this.clone(), e.collapse(), e.insertNode(c));
                e = this.clone();
                e.collapse(!0);
                e.insertNode(b);
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    for (h = c(h); h || p;) {
                        ...
                        for (; p;) if (z = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
                        else {
                            if (p.type == CKEDITOR.NODE_TEXT) F = p.getText(),
                            d.test(F) && (p = null),
                            z = /[\s\ufeff]$/.test(F);
                            else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark")) if (x && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                F = p.getText();
                                if (d.test(F)) p = null;
                                else for (var B = p.$.getElementsByTagName("*"), E = 0, v; v = B[E++];) if (!CKEDITOR.dtd.$removeEmpty[v.nodeName.toLowerCase()]) {
                                    p = null;
                                    break
                                }
                                p && (z = !!F.length)
                        ...
                        for (; p;) {
                            ...
                            z = /^[\s\ufeff]/.test(F);
                                ...
                                if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark")) if (x && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                    F = p.getText();
                                    if (d.test(F)) p = null;
                                    else for (B = p.$.getElementsByTagName("*"), E = 0; v = B[E++];) if (!CKEDITOR.dtd.$removeEmpty[v.nodeName.toLowerCase()]) {
                                        p = null;
                                        break
                                    }
                                    p && (z = !!F.length)
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var q, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                        br: 1
                    }: null),
                    C = null,
                    I = function(a) {
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    n && n.type == CKEDITOR.NODE_TEXT && (k ? k >= n.getLength() ? d.setEndAfter(n) : (d.setEndAfter(n), t = 0) : d.setEndBefore(n));
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                c = CKEDITOR.dom.walker.bookmark(!1);
                return function(b) {
                    for (var c = this.createBookmark(), d = this[b ? "endPath": "startPath"](), e = d.block || d.blockLimit, g; e && !e.equals(d.root) && !e.getFirst(a(e));) g = e.getParent(),
            ...
            moveToClosestEditablePosition: function(a, b) {
                var c, d = 0,
                e, n, g = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
    ...
    "use strict"; (function() {
        ...
        function b(a, c, e, g) {
            ...
            if (!g) return 0;
            if ((k = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !k.check(c)) return b(a, c, e, g.remaining);
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (this._.nestedEditable) {
                    if (d = this._.nestedEditable.iterator.getNextParagraph(a)) return this.activeFilter = this._.nestedEditable.iterator.activeFilter,
                    d;
                ...
                if (!this._.started) {
                    ...
                    k = n.startPath();
                    var w = n.endPath(),
                    H = !n.collapsed && c(n, k.block),
                    u = !n.collapsed && c(n, w.block, 1);
                ...
                for (this._.nextNode = null; w;) {
                    var H = 0,
                    u = w.hasAscendant("pre"),
                    t = w.type != CKEDITOR.NODE_ELEMENT,
                    h = 0;
                    if (t) w.type == CKEDITOR.NODE_TEXT && e.test(w.getText()) && (t = 0);
                    else {
                        var p = w.getName();
                        if (CKEDITOR.dtd.$block[p] && "false" == w.getAttribute("contenteditable")) {
                            ...
                            b(this, a, d);
                            break
                        } else if (w.isBlockBoundary(this.forceBrBreak && !u && {
                            br: 1
                        })) {
                            if ("br" == p) t = 1;
                            else if (!k && !w.getChildCount() && "hr" != p) {
                                d = w;
                                A = w.equals(n);
                                break
                            }
                    ...
                    if (k && !H) for (; ! w.getNext(l) && !A;) {
                        p = w.getParent();
                        if (p.isBlockBoundary(this.forceBrBreak && !u && {
                            br: 1
                        })) {
                            H = 1;
                            t = 0;
                ...
                if (!d) {
                    if (!k) return this._.docEndMarker && this._.docEndMarker.remove(),
    ...
    CKEDITOR.config = {
        ...
        function a(a, b, c, d, e) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                if (!0 === h.elements || null === h.elements) e[p ? "unshift": "push"](h);
                else for (z in m = h.elements, delete h.elements, m) if (b[z]) b[z][p ? "unshift": "push"](h);
                else b[z] = [h]
            }
        }
        function d(a, c, d, h) {
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                if (a) {
                    for (var d = !1,
                    h = !0 === a,
                    p = b.length; p--;) if (h || a(b[p])) b.splice(p, 1),
                    d = !0;
                    a = d
                } else a = !1;
        ...
        function e(a, b) {
            ...
            d = !0 === a,
            h;
            for (h in b) if (d || a(h)) delete b[h],
            c = !0;
            return c
        }
        function g(a, b, c) {
        ...
        function k(a, b) {
            if (!a) return ! 1;
            if (!0 === a) return a;
            if ("string" == typeof a) return a = Y(a),
        ...
        function f(a) {
            var b, c, d, h, p = {},
            e = 1;
            for (a = Y(a); b = a.match(C);)(c = b[2]) ? (d = y(c, "styles"), h = y(c, "attrs"), c = y(c, "classes")) : d = h = c = null,
            p["$" + e++] = {
                elements: b[1],
                classes: c,
                styles: d,
        ...
        function r(a, b, h, e) {
            ...
            if (e.doFilter) {
                ...
                k && (m = 1);
                if (!e.skipFinalValidation && !w(b)) return h.push(b),
                1
            }
        ...
        function t(a) {
            return a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || B.$block[a.name])
        }
        function h(a, b, c) {
            var d = a.name;
            ...
            else if (B.$block[d] || "tr" == d) if ("br" == b) a.previous && !t(a.previous) && (b = u(), b.insertBefore(a)),
            a.next && !t(a.next) && (b = u(), b.insertAfter(a)),
            a.replaceWithChildren();
                ...
                b: {
                    ...
                    for (var p = 0,
                    e = d.length,
                    m; p < e; ++p) if (m = d[p], m.type == CKEDITOR.NODE_ELEMENT && !h[m.name]) {
                        h = !1;
                        break b
                    }
                    h = !0
                ...
                c.push({
                    ...
                    h = a.parent;
                    for (var p = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name,
                    f, g, e = d.length; 0 < e;) m = d[--e],
                    p && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && B.$inline[m.name]) ? (f || (f = new CKEDITOR.htmlParser.element(b), f.insertAfter(a), c.push({
                        check: "parent-down",
                        el: f
        ...
        CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                a = this.editor = a;
                this.customConfig = !0;
                var b = a.config.allowedContent; ! 0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(P[a.enterMode] + " " + P[a.shiftEnterMode], "default", 1), this.disallow(a.config.disallowedContent))
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                if ("string" == typeof b) b = f(b);
                    ...
                    d && (d = E(d), h.classes = d["class"] ? d["class"].split(/\s+/) : null, h.requiredClasses = h.classes, delete d["class"], h.attributes = d, h.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (f = r(p, a, e, n), f & 1) g = !0;
                ...
                case "it":
                    ...
                    break;
                case "el-up":
                    c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || h(c, d, a);
                    break;
                case "parent-down":
            ...
            addContentForms: function(a) {
                if (!this.disabled && a) {
                    var b, c, d = [],
                    h;
                    for (b = 0; b < a.length && !h; ++b) c = a[b],
                    ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (h = c);
                    if (h) {
            ...
            addTransformations: function(a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        t = void 0;
                        c = [];
                        for (e = 0; e < b.length; ++e) m = b[e],
                        "string" == typeof m ? (m = m.split(/\s*:\s*/), f = m[0], g = null, t = m[1]) : (f = m.check, g = m.left, t = m.right),
                        p || (p = m, p = p.element ? p.element: f ? f.match(/^([a-z0-9]+)/i)[0] : p.left.getDefinition().element),
                        g instanceof CKEDITOR.style && (g = z(g)),
                        c.push({
                            check: f == p ? null: f,
                            left: g,
            ...
            check: function(a, b, c) {
                ...
                h = d.styles,
                m = d.attributes || {},
                h && !CKEDITOR.tools.isEmpty(h) ? (h = E(h), m.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {},
                h = {
                    name: d.element,
                    attributes: m,
                ...
                if (!1 !== b && (t = this._.transformations[h.name])) {
                    for (d = 0; d < t.length; ++d) p(this, h, t[d]);
                    n(h)
                }
                r(this, m, g, {
                    doFilter: !0,
        ...
        J = CKEDITOR.filter.transformationsTools = {
            ...
            transform: function(a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    f;
                    a.name = c.element;
                    for (p in h) if ("class" == p) for (c = a.classes.join("|"), m = h[p].split(/\s+/); f = m.pop();) - 1 == c.indexOf(f) && a.classes.push(f);
        ...
        return {
            load: function(b, c, e, g) {
                ...
                if (0 === l) f(!0);
                    ...
                    var y = function(a, b) { (b ? q: v).push(a);
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function(a, d, b) {
            ...
            q = 0; q < a.length; q++) {
                var v = a[q];
                if (v) if (c[v] || e[v]) l[v] = this.get(v);
                else {
            ...
            k = function(b) {
                ...
                function(a) {
                    ...
                    if (b.length) k.call(this, b);
                        ...
                        for (f in g) l = g[f],
                        l.onLoad && !l.onLoad._called && (!1 === l.onLoad() && delete g[f], l.onLoad._called = 1);
                        c && c.call(e || window, g)
                    }
                },
                this)
    ...
    CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
        ...
        function k(a) {
            ...
            c = D[b] || (D[b] = {});
            c.fn ? (c.fn.call(a, a.config), CKEDITOR.getUrl(a.config.customConfig) != b && k(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b,
            function() {
        ...
        function y(a) {
            ...
            function(c) {
                ...
                function() {
                    for (var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++) for (var p = 0; p < d.length; p++) {
                        var m = d[p];
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            destroy: function(a) {
                this.fire("beforeDestroy"); ! a && A.call(this);
                this.editable(null);
    ...
    CKEDITOR.htmlParser = function() {
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, e, g = 0,
                k; c = this._.htmlPartsRegex.exec(b);) {
                    e = c.index;
                    if (e > g) if (g = b.substring(g, e), k) k.push(g);
                    else this.onText(g);
                    ...
                    if (k) k.push(c[0]);
                        ...
                        if (e = e.toLowerCase(), !/="/.test(e)) {
                            ...
                            this.onTagOpen(e, l, c); ! k && CKEDITOR.dtd.$cdata[e] && (k = [])
                        }
    ...
    CKEDITOR.htmlParser.comment.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
        ...
        filter: function(a, d) {
            var b = this.value;
            if (! (b = a.onComment(d, b, this))) return this.remove(),
            !1;
    ...
    "use strict"; (function() {
        ...
        CKEDITOR.htmlParser.text.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, d) {
                if (! (this.value = a.onText(d, this.value, this))) return this.remove(),
                !1
            },
            writeHtml: function(a, d) {
                d && this.filter(d);
    ...
    CKEDITOR.htmlParser.fragment = function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(g, k, l) {
            function q(a) {
                var b;
            ...
            n = k instanceof CKEDITOR.htmlParser.element ? k: "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment,
            w = [],
            H = [],
            u = n,
            t = "textarea" == n.name,
            ...
            D.onTagOpen = function(e, m, f, g) {
                ...
                if (a(m)) w.push(m);
                    ...
                    if ("br" == e) H.push(m);
                        ...
                        else if (e in b && f in b) f = u.children,
                        (f = f[f.length - 1]) && "li" == f.name || y(f = new CKEDITOR.htmlParser.element("li"), u),
                        !m.returnPoint && (m.returnPoint = u),
                        u = f;
                        else if (e in CKEDITOR.dtd.$listItem && !r(e, f)) D.onTagOpen("li" == e ? "ul": "dl", {},
                        0, 1);
                        else if (f in d && !r(e, f)) ! m.returnPoint && (m.returnPoint = u),
                        u = u.parent;
                        else if (f in CKEDITOR.dtd.$inline && w.unshift(u), u.parent) y(u, u.parent, 1);
                        else {
                            m.isOrphan = 1;
                            break
                        }
            ...
            D.onTagClose = function(a) {
                ...
                for (var c = [], d = [], h = u; h != n && h.name != a;) h._.isBlockLike || d.unshift(h),
                c.push(h),
    ...
    "use strict"; (function() {
        ...
        a.prototype = {
            ...
            findIndex: function(a) {
                ...
                d = c.length - 1; 0 <= d && a < c[d].priority;) d--;
                return d + 1
            },
            exec: function(a, c) {
                ...
                f,
                y;
                for (y = 0; y < l; y++) if (d && (q = c.type, v = c.name), f = k[y], !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
        ...
        function a(a, d) {
            ...
            function m(a, d) {
                return function(h) {
                    if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        t,
                        G;
                        if (m) for (p(m, 1) && e.push(m); m;) g(m) && (t = c(m)) && p(t) && ((G = c(t)) && !g(G) ? e.push(t) : (f(x).insertAfter(t), t.remove())),
                        m = m.previous;
                        for (m = 0; m < e.length; m++) e[m].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(h) : d)) x || CKEDITOR.env.needsBrFiller || h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? x || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || h.name in CKEDITOR.dtd.tr || h.name in CKEDITOR.dtd.$listItem) ? (e = b(h), e = !e || "form" == h.name && "input" == e.name) : e = !1 : e = !1;
                        e && h.add(f(a))
                    }
                }
            }
            function p(a, b) {
                ...
                var c;
                return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(w)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && x && (!b || a.parent.name in F) || !x && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
            }
            var t = {
                elements: {}
            },
                ...
                return function(b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
                            ...
                            var h = c(b); ! d && g(b.parent) ? k(b.parent, f(a)) : g(d) && h && !g(h) && f(a).insertBefore(d)
                        }
                    }
                }
            } (x);
        ...
        function n(a, b) {
            ...
            for (var m = 0; m < d.length; m++) a = a.replace(d[m],
            function(a) {
                a = a.replace(e,
                function(a, b, d) {
                    return c[d]
        ...
        H = "{cke_protected}",
        u = CKEDITOR.dtd,
        t = "caption colgroup col thead tfoot tbody".split(" "),
        h = CKEDITOR.tools.extend({},
        u.$blockLimit, u.$block),
        p = {
            elements: {
                input: l,
                textarea: l
            ...
            elements: {
                $: function(a) {
                    ...
                    if (b) {
                        ...
                        for (var c = ["name", "href", "src"], d, h = 0; h < c.length; h++) d = "data-cke-saved-" + c[h],
                        d in b && delete b[c[h]]
                    }
                    return a
                },
                table: function(a) {
                    a.children.slice(0).sort(function(a, b) {
                        var c, d;
                        a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(t, a.name), d = CKEDITOR.tools.indexOf(t, b.name)); - 1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex() : -1, d = b.parent ? b.getIndex() : -1);
                        return c > d ? 1 : -1
                    })
                },
                param: function(a) {
    ...
    CKEDITOR.htmlParser.cssStyle = function(a) {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (;;) {
                    k = d.name;
                    if (! (l = a.onElementName(b, k))) return this.remove(),
                    !1;
                    d.name = l;
                    if (! (d = a.onElement(b, d))) return this.remove(),
                    !1;
                    if (d !== this) return this.replaceWith(d),
                    !1;
                    if (d.name == k) break;
                    if (d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d),
                    !1;
                    if (!d.name) return this.replaceWithChildren(),
                    !1
                }
                k = d.attributes;
                var q, v;
                for (q in k) {
                    for (l = k[q];;) if (v = a.onAttributeName(b, q)) if (v != q) delete k[q],
                    q = v;
                    else break;
                    else {
                        delete k[q];
                    ...
                    v && (!1 === (l = a.onAttribute(b, d, v, l)) ? delete k[v] : k[v] = l)
                }
            ...
            getFirst: function(b) {
                ...
                for (var d = 0,
                g = this.children.length; d < g; ++d) if (b(this.children[d])) return this.children[d];
                return null
            },
            getHtml: function() {
    ...
    CKEDITOR.replaceClass = "ckeditor"; (function() {
        function a(a, e, g, k) {
            ...
            function() {
                b(l);
                k == CKEDITOR.ELEMENT_MODE_REPLACE && l.config.autoUpdateElement && a.$.form && l._attachToForm();
                l.setMode(l.config.startupMode,
                function() {
                    l.resetDirty();
                    l.status = "ready";
        ...
        CKEDITOR.replaceAll = function() {
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                ...
                if (k.name || k.id) {
                    ...
                    } else if ("function" == typeof arguments[0] && (d = {},
                    !1 === arguments[0](k, d))) continue;
                    this.replace(k, d)
                }
            }
        };
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    ...
                    "source" == d.mode && k == q && (d.fire("lockSnapshot", {
                        forceUpdate: !0
                    }), v = 1);
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
            ...
            k.setSize("width", a, !0);
            v && (v.style.width = "1%");
            var f = (k.$.offsetHeight || 0) - (q.$.clientHeight || 0),
    ...
    CKEDITOR.config.startupMode = "wysiwyg"; (function() {
        function a(a) {
            ...
            g = f.getRanges()[0],
            F;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (f = d(f, e)) f.appendBogus(),
            F = CKEDITOR.env.ie;
            ...
            !m.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = g.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div": "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), F = 1, a.cancel());
            F && g.select()
        }
        function d(a, b) {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    A(a.startContainer) && a.startContainer.appendBogus();
                ...
                setup: function() {
                    ...
                    function() {
                        var b = this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(D,
                        function(a, b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                    ...
                    if (!this.is("textarea")) {
                        ...
                        function(b) {
                            ...
                            if (b in l) {
                                ...
                                if (d.collapsed) a: {
                                    ...
                                    if (h && d[c ? "checkStartOfBlock": "checkEndOfBlock"]() && d.moveToClosestEditablePosition(h, !c) && d.collapsed) {
                                        ...
                                        if (!d || d && d.contains(h)) b = void 0;
                                            ...
                                            a.fire("saveSnapshot");
                                            var f; (f = (c ? d: h).getBogus()) && f.remove();
                                            f = a.getSelection();
                                            e = f.createBookmarks(); (c ? h: d).moveChildren(c ? d: h, !1);
                                ...
                                f = b.block,
                                d = c.endPath().block,
                                f && d && !f.equals(d) ? (a.fire("saveSnapshot"), (h = f.getBogus()) && h.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), v(f, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b) return;
        ...
        n = function() {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var k = B[k.getName()], x = 0, l = c.getChildren(), F = l.count(), z = -1, n = -1, q = 0, v = e.contains(B.$list); x < F; ++x) e = l.getItem(x),
                a(e) ? (m = e.getName(), v && m in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (p = !!k[m], "br" != m || !e.data("cke-eol") || x && x != F - 1 || (q = (f = x ? g[x - 1].node: l.getItem(x + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && B.$block[f.getName()]), -1 != z || p || (z = x), p || (n = x), g.push({
                    isElement: 1,
                    isLineBreak: q,
                    ...
                    node: e,
                    allowed: 1
                }); - 1 < z && (g[z].firstNotAllowed = 1); - 1 < n && (g[n].lastNotAllowed = 1);
                return g
            }
            function d(b, c) {
                var e = [],
                ...
                g = 0,
                k = B[c],
                x = !b.is(B.$inline) || b.is("br");
                for (x && e.push(" "); g < f; g++) m = h.getItem(g),
                a(m) && !m.is(k) ? e = e.concat(d(m, c)) : e.push(m);
                x && e.push(" ");
                return e
            }
            function e(b) {
            ...
            function g(b, c, d, e) {
                ...
                f,
                m;
                h.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (f = (new CKEDITOR.dom.walker(h)).next()) && a(f) && n[f.getName()] && (m = f.getPrevious()) && a(m) && !m.getParent().equals(b.startContainer) && d.contains(m) && e.contains(f) && f.isIdentical(m) && (f.moveChildren(m), f.remove(), g(b, c, d, e))
            }
            function F(b, c) {
                function d(b, c) {
            ...
            return function(n, E, C, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    if (!E.collapsed) {
                        var G = J.block || J.blockLimit,
                        w = E.getCommonAncestor();
                        G && !G.equals(w) && !G.contains(w) && E.checkEndOfBlock() && n.zombies.push(G);
                        E.deleteContents()
                    }
                    ...
                    L = E.startPath();
                    if (G = L.contains(f, !1, 1)) E.splitElement(G),
                    n.inlineStylesRoot = G,
                    n.inlineStylesPeak = L.lastElement;
                    L = E.createBookmark(); (G = L.startNode.getPrevious(c)) && a(G) && f(G) && I.push(G); (G = L.startNode.getNext(c)) && a(G) && f(G) && I.push(G);
                    ...
                    if (L = C) {
                        ...
                        if ("text" == n.type && n.inlineStylesRoot) {
                            ...
                            for (I = n.inlineStylesRoot.getParent(); ! r.equals(I);) E = E.appendTo(r.clone()),
                            r = r.getParent();
                    ...
                    if (L) {
                        ...
                        X,
                        J = K.getPosition(E),
                        w = !!K.getCommonAncestor(E) && J != CKEDITOR.POSITION_IDENTICAL && !(J & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        E = b(n.dataWrapper, n);
                        for (F(E, y); I < E.length; I++) {
                            ...
                            if (u = J.isLineBreak) {
                                ...
                                J.hasBlockSibling ? u = 1 : (T = u.startContainer.getAscendant(B.$block, 1)) && T.is({
                                    div: 1,
                                    p: 1
                                }) ? (aa = T.getPosition(R), aa == CKEDITOR.POSITION_IDENTICAL || aa == CKEDITOR.POSITION_CONTAINS ? u = 0 : (R = u.splitElement(T), u.moveToPosition(R, CKEDITOR.POSITION_AFTER_START), u = 1)) : u = 0
                            }
                            if (u) C = 0 < I;
                            else {
                                u = y.startPath(); ! J.isBlock && k(n.editor, u.block, u.blockLimit) && (H = l(n.editor)) && (H = L.createElement(H), H.appendBogus(), y.insertNode(H), CKEDITOR.env.needsBrFiller && (D = H.getBogus()) && D.remove(), y.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END));
                                if ((u = y.startPath().block) && !u.equals(M)) {
                                    if (D = u.getBogus()) D.remove(),
                                    A.push(u);
                                    M = u
                                }
                                ...
                                if (G && J.isElement) {
                                    ...
                                    if (u) R && (W = y.splitElement(R), n.zombies.push(W), n.zombies.push(R));
                                    else {
                                        R = r.getName();
                                        X = !I;
                                        u = I == E.length - 1;
                                        R = d(J.node, R);
                                        for (var T = [], aa = R.length, ba = 0, da = void 0, ea = 0, ga = -1; ba < aa; ba++) da = R[ba],
                                        " " == da ? (ea || X && !ba || (T.push(new CKEDITOR.dom.text(" ")), ga = T.length), ea = 1) : (T.push(da), ea = 0);
                                        u && ga == T.length && T.pop();
                                        X = T
                                    }
                                }
                                ...
                                J.lastNotAllowed && I < E.length - 1 && ((W = w ? K: W) && y.setEndAt(W, CKEDITOR.POSITION_AFTER_START), G = 0);
                                y.collapse()
                            }
                        }
        ...
        u = function() {
            ...
            function b(c, d, e) {
                a(d);
                a(e, 1);
                for (var f; f = e.getNext();) f.insertAfter(d),
                d = f;
                A(c) && c.remove()
            }
            function c(a, b) {
            ...
            return {
                ...
                table: function() {
                    function a(c) {
                        ...
                        h.guard = function(a, h) {
                            ...
                            if (h && g && a.equals(g)) f = c.clone(),
                            f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END),
                            e.push(f);
                            else if (!h && m && a.equals(m)) f = c.clone(),
                            f.setStartAt(m, CKEDITOR.POSITION_AFTER_START),
                            e.push(f);
                            else {
                    ...
                    return {
                        ...
                        detectRanges: function(e, f) {
                            ...
                            n = n.contains("table");
                            l = l.contains("table");
                            if (n || l) n && l && b(n, l) ? (e.tableSurroundingRange = g, g.setStartAt(n, CKEDITOR.POSITION_AFTER_END), g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), g = h.clone(), g.setEndAt(n, CKEDITOR.POSITION_AFTER_END), k = h.clone(), k.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), k = a(g).concat(a(k))) : n ? l || (e.tableSurroundingRange = g, g.setStartAt(n, CKEDITOR.POSITION_AFTER_END), h.setEndAt(n, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = g, g.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), h.setStartAt(l, CKEDITOR.POSITION_AFTER_START)),
                            e.tableContentsRanges = k ? k: a(h)
                        },
                        deleteRanges: function(a) {
                            for (var b; b = a.tableContentsRanges.pop();) b.extractContents(),
                            A(b.startContainer) && b.startContainer.appendBogus();
                ...
                autoParagraph: function(a, b) {
                    var c = b.startPath(),
                    d;
                    k(a, c.block, c.blockLimit) && (d = l(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d, CKEDITOR.POSITION_AFTER_START))
                }
            }
        } ()
    })(); (function() {
        ...
        var y, A, r = CKEDITOR.dom.walker.invisible(1),
        D = function() {
            function a(b) {
                return function(a) {
        ...
        function(b) {
            ...
            function() {
                ...
                if (CKEDITOR.env.ie || q) n ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1),
                ...
                if (q && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    ...
                    g.attachListener(f.getDocumentElement(), "mouseup",
                    function() {
                        G && d.call(e);
                        G = 0
                    })
                } else g.attachListener(CKEDITOR.env.ie ? g: f.getDocumentElement(), "mouseup", d, e);
                CKEDITOR.env.webkit && g.attachListener(f, "keydown",
                function(a) {
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                ...
                function() {
                    ...
                    var b = function(b, c) {
                        ...
                        f, h, g = b.duplicate(), k = 0, l = e.length - 1, C = -1, m, n; k <= l;) if (C = Math.floor((k + l) / 2), f = e[C], g.moveToElementText(f), m = g.compareEndPoints("StartToStart", b), 0 < m) l = C - 1;
                        else if (0 > m) k = C + 1;
                        else return {
                            container: d,
                            offset: a(f)
                        ...
                        if ( - 1 == C || C == e.length - 1 && 0 > m) {
                            ...
                            for (d = e.length; 0 < g && 0 < d;) h = e[--d],
                            h.nodeType == CKEDITOR.NODE_TEXT && (n = h, g -= h.nodeValue.length);
                            return {
                                container: n,
                                offset: -g
                            }
                        ...
                        for (; 0 < g;) try {
                            h = f[0 < m ? "previousSibling": "nextSibling"],
                            h.nodeType == CKEDITOR.NODE_TEXT && (g -= h.nodeValue.length, n = h),
                            f = h
                        } catch(K) {
                            return {
                                container: d,
                        ...
                        return {
                            container: n,
                            offset: 0 < m ? -g: n.nodeValue.length + g
                        }
                    };
                    return function() {
            ...
            selectRanges: function(a) {
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    a: {
                        var q, v;
                        if (1 == a.length && !(v = a[0]).collapsed && (l = v.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (v = v.clone(), v.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (q = v.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT && (l = q), "false" == l.getAttribute("contenteditable"))) break a;
                        l = void 0
                    }
                    if (l) this.fake(l);
                    else {
                        if (n) {
                            ...
                            if (l.startContainer.type == CKEDITOR.NODE_ELEMENT && l.startContainer.getName() in b || l.endContainer.type == CKEDITOR.NODE_ELEMENT && l.endContainer.getName() in b) l.shrink(CKEDITOR.NODE_ELEMENT, !0),
                            a = l.collapsed;
                            t = l.createBookmark();
                            b = t.startNode;
                            a || (f = t.endNode);
                            ...
                            f ? (q = l.document.$.body.createTextRange(), q.moveToElementText(f.$), t.setEndPoint("EndToEnd", q), t.moveEnd("character", -1)) : (r = b.getNext(v), u = b.hasAscendant("pre"), r = !(r && r.getText && r.getText().match(q)) && (u || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), u = l.document.createElement("span"), u.setHtml("\x26#65279;"), u.insertBefore(b), r && l.document.createText("﻿").insertBefore(b));
                            l.setStartBefore(b);
                            b.remove();
                            ...
                            for (t = 0; t < a.length; t++) {
                                ...
                                l.collapsed && CKEDITOR.env.webkit && e(l) && (q = g(this.root), l.insertNode(q), (r = q.getNext()) && !q.getPrevious() && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() ? (k(this.root), l.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START)) : l.moveToPosition(q, CKEDITOR.POSITION_AFTER_END));
                                u.setStart(l.startContainer.$, l.startOffset);
                                try {
                                    u.setEnd(l.endContainer.$, l.endOffset)
                                } catch(C) {
                                    if (0 <= C.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1),
                                    u.setEnd(l.endContainer.$, l.endOffset);
                                    else throw C;
                                }
                                f.addRange(u)
    ...
    CKEDITOR.STYLE_OBJECT = 3; (function() {
        ...
        function b(c) {
            ...
            c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (r.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    l = !1;
                    if (r.equals(v)) r = null,
                    l = !0;
                    else {
                        var y = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
                        u = y && "false" == r.getAttribute("contentEditable"),
                        w = y && r.getAttribute("data-nostyle");
                        if (y && r.data("cke-bookmark")) {
                            r = r.getNextSourceNode(!0);
                            continue
                        }
                        if (u && n && CKEDITOR.dtd.$block[y]) for (var A = r,
                        x = e(A), z = void 0, B = x.length, E = 0, A = B && new CKEDITOR.dom.range(A.getDocument()); E < B; ++E) {
                            var z = x[E],
                            F = CKEDITOR.filter.instances[z.data("cke-filter")];
                            if (F ? F.check(this) : 1) A.selectNodeContents(z),
                            b.call(this, A)
                        }
                        x = y ? !m[y] || w ? 0 : u && !n ? 0 : d(r, v, h, O) : 1;
                        if (x) if (z = r.getParent(), x = h, B = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[B] && !E || x.parentRule && !x.parentRule(z)) l = !0;
                        else {
                            if (t || y && CKEDITOR.dtd.$removeEmpty[y] && (r.getPosition(v) | O) != O || (t = c.clone(), t.setStartBefore(r)), y = r.type, y == CKEDITOR.NODE_TEXT || u || y == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                                for (var y = r,
                                P; (l = !y.getNext(Y)) && (P = y.getParent(), m[P.getName()]) && d(P, q, h, N);) y = P;
                                t.setEndAfter(y)
                            }
                        } else l = !0;
                    ...
                    if (l && t && !t.collapsed) {
                        for (var l = H(this, f), u = l.hasAttributes(), w = t.getCommonAncestor(), y = {},
                        x = {},
                        z = {},
                        B = {},
                        S, V, ca; l && w;) {
                            if (w.getName() == g) {
                                for (S in h.attributes) ! B[S] && (ca = w.getAttribute(V)) && (l.getAttribute(S) == ca ? x[S] = 1 : B[S] = 1);
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                p = this;
                b();
                for (e = d; ! e.equals(m);) f = e.getNextSourceNode(),
                e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? r.call(this, e) : n(e, h(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())),
                e = f
            }
            a.moveToBookmark(c);
        ...
        function l(a) {
            ...
            f; d = c.getNextParagraph();) ! d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = H(this, e, d), v(d, f));
            a.moveToBookmark(b)
        }
        function q(a) {
            ...
            for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null: a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p": "div")) && d.copyAttributes(e), v(d, e)) : r.call(this, d));
            a.moveToBookmark(b)
        }
        function v(a, b) {
            var c = !b;
        ...
        function D(a) {
            for (var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e),
            d.isReadOnly() || r.call(this, d, !0);
            for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e),
        ...
        function w(a, b) {
            if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) {
                var c = a.getPrevious(P),
                d = a.getNext(P); ! c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({
                    br: 1
        ...
        function t(a, b) {
            for (var c in a) a[c] = a[c].replace(E,
            function(a, c) {
                return b[c]
            })
        }
        ...
        P = CKEDITOR.dom.walker.whitespaces(1);
        CKEDITOR.style = function(a, b) {
            ...
            this.type = a.type || (z[c] ? CKEDITOR.STYLE_BLOCK: F[c] ? CKEDITOR.STYLE_OBJECT: CKEDITOR.STYLE_INLINE);
        ...
        CKEDITOR.style.prototype = {
            ...
            buildPreview: function(a) {
                ...
                var c = ["\x3c", d],
                e = b.attributes;
                if (e) for (var f in e) c.push(" ", f, '\x3d"', e[f], '"'); (e = CKEDITOR.style.getStyleText(b)) && c.push(' style\x3d"', e, '"');
    ...
    "use strict"; (function() {
        ...
        CKEDITOR.dom.elementPath = function(b, e) {
            ...
            if (q.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (q.equals(e)) break;
                if (!k && (v = q.getName(), "true" == q.getAttribute("contenteditable") ? k = q: !g && d[v] && (g = q), a[v])) {
                    if (v = !g && "div" == v) {
                        a: {
                            v = q.getChildren();
                            for (var f = 0,
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        var d = {
                ...
                return {
                    getNextRange: function(k) {
                        ...
                        if (l && 1 < a.length) {
                            ...
                            for (l.moveToBookmark(d.shift()); v--;) q = a[++g],
                            q.moveToBookmark(d.shift()),
                            l.setEnd(q.endContainer, q.endOffset)
                        }
                        return l
                    }
                }
            ...
            createBookmarks: function(b) {
                for (var c = [], d, g = 0; g < this.length; g++) {
                    ...
                    for (var k = g + 1; k < this.length; k++) this[k] = a(d, this[k]),
                    this[k] = a(d, this[k], !0)
                }
                return c
            },
        ...
        if (a = CKEDITOR._.pending) for (delete CKEDITOR._.pending, d = 0; d < a.length; d++) CKEDITOR.editor.prototype.constructor.apply(a[d][0], a[d][1]),
        CKEDITOR.add(a[d][0])
    })();
    /*
 Copyright (c) 2003-2016, CKSource - Frederico Knabben. All rights reserved.
...
*/
    ...
    CKEDITOR.plugins.add("dialogui", {
        onLoad: function() {
                ...
                html: function() {
                    ...
                    return function(f, c, e) {
                        if (! (3 > arguments.length)) {
                            ...
                            if (k) {
                                var l = this.focus;
                                this.focus = function() { ("function" == typeof k ? k: l).call(this);
                                    this.fire("focus")
                                };
            ...
            CKEDITOR.ui.dialog.textInput.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, {
                ...
                setValue: function(b) {
                    if (this.bidi) {
                        var a = b && b.charAt(0); (a = "‪" == a ? "ltr": "‫" == a ? "rtl": null) && (b = b.slice(1));
    ...
    CKEDITOR.DIALOG_STATE_BUSY = 2; (function() {
        function x() {
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            function e(b) {
                if (l == CKEDITOR.dialog._.currentTop) {
                    ...
                    g = [37, 38, 39, 40];
                    q = n = 0;
                    if (9 == c || c == CKEDITOR.SHIFT + 9) d(c == CKEDITOR.SHIFT + 9 ? -1 : 1),
                    q = 1;
                    else if (c == CKEDITOR.ALT + 121 && !l._.tabBarMode && 1 < l.getPageCount()) l._.tabBarMode = !0,
                    l._.tabs[l._.currentTabId][0].focus(),
                    l._.currentFocusIndex = -1,
                    q = 1;
                    else if ( - 1 != CKEDITOR.tools.indexOf(g, c) && l._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], c) ? x.call(l) : A.call(l),
                    l.selectPage(c),
                    l._.tabs[c][0].focus(),
                    q = 1;
                    else if (13 != c && 32 != c || !l._.tabBarMode) if (13 == c) c = b.data.getTarget(),
                    c.is("a", "button", "select", "textarea") || c.is("input") && "button" == c.$.type || ((c = this.getButton("ok")) && CKEDITOR.tools.setTimeout(c.click, 0, c), q = 1),
                    n = 1;
            ...
            k = {},
            q,
            n; ("OS" == p && CKEDITOR.env.mac || "rtl" == p && "ltr" == m || "ltr" == p && "rtl" == m) && h.buttons.reverse();
            ...
            if (g.onCancel) this.on("cancel",
            function(a) { ! 1 === g.onCancel.call(this, a) && (a.data.hide = !1)
            });
            var l = this,
            t = function(a) {
                var b = l._.contents,
            ...
            this);
            Y(this);
            Z(this); (new CKEDITOR.dom.text(g.title, CKEDITOR.document)).appendTo(this.parts.title);
        ...
        D = function(a, b, c) {
            for (var d = 0,
            e; e = a[d]; d++) if (e.id == b || c && e[c] && (e = D(e[c], b, c))) return e;
            return null
        },
        ...
        Q = function(a) {
            ...
            c = a.data.$.altKey,
            d = a.data.$.shiftKey,
            e = String.fromCharCode(a.data.$.keyCode); (b = w[(b ? "CTRL+": "") + (c ? "ALT+": "") + (d ? "SHIFT+": "") + e]) && b.length && (b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog, b.key), a.data.preventDefault())
        },
        R = function(a) {
            var b = a.data.$.ctrlKey || a.data.$.metaKey,
            c = a.data.$.altKey,
            d = a.data.$.shiftKey,
            e = String.fromCharCode(a.data.$.keyCode); (b = w[(b ? "CTRL+": "") + (c ? "ALT+": "") + (d ? "SHIFT+": "") + e]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key), a.data.preventDefault()))
        },
        S = function(a, b, c, d, e) { (w[c] || (w[c] = [])).push({
                uiElement: a,
                dialog: b,
                key: c,
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function(a, b, c, d, e, f, g) {
                    if (! (4 > arguments.length)) {
                        ...
                        c.push(p.join("")); (this._ || (this._ = {})).dialog = a;
    ...
    CKEDITOR.config.coreStyles_superscript = {
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        for (b = e.length - 1; 0 <= b; b--) {
                            ...
                            a: {
                                d = c;
                                for (var f = 0,
                                m = d.getChildCount(), l = void 0; f < m && (l = d.getChild(f)); f++) if (l.type == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary()) {
                                    d = !1;
                                    break a
                                }
                                d = !0
                        ...
                        if (g.config.enterMode == CKEDITOR.ENTER_BR) for (c = !0; a.length;) if (f = a.shift(), "div" == f.getName()) {
                            b = new CKEDITOR.dom.documentFragment(g.document); ! c || !f.getPrevious() || f.getPrevious().type == CKEDITOR.NODE_ELEMENT && f.getPrevious().isBlockBoundary() || b.append(g.document.createElement("br"));
        ...
        function r(b, a, c) {
            ...
            if (CKEDITOR.env.gecko && "drop" == a.method && b.toolbox) b.once("afterPaste",
            function() {
                b.toolbox.focus()
            });
        ...
        function y(b) {
            function a() {
                ...
                a.on(n.mainPasteEvent,
                function(b) {
                    "beforepaste" == n.mainPasteEvent && p || k(b)
                });
                "beforepaste" == n.mainPasteEvent && (a.on("paste",
                function(a) {
                    v || (e(), a.data.preventDefault(), k(a), f("paste") || b.openDialog("paste"))
                }), a.on("contextmenu", g, null, null, 0), a.on("beforepaste",
                function(b) { ! b.data || b.data.$.ctrlKey || b.data.$.shiftKey || g()
                },
                null, null, 0));
                a.on("beforecut",
                function() { ! p && h(b)
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.safari && m.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select", "text")); (k = m.getParent().isReadOnly()) ? (m.setOpacity(0), m.setAttribute("contenteditable", !0)) : m.setStyle("ltr" == b.config.contentsLangDirection ? "left": "right", "-10000px");
            ...
            function z() {
                ...
                a.lock();
                if (b.editable().fire(n.mainPasteEvent) && !f("paste")) return a.unlock(),
                !1;
                a.unlock();
                return ! 0
            }
            ...
            b.getClipboardData = function(a, d) {
                ...
                null, null, 1E3); ! 1 === z() && (b.removeListener("paste", c), q && b.fire("pasteDialog", f) ? (b.on("pasteDialogCommit", e), b.on("dialogHide",
                function(a) {
                    a.removeListener();
        ...
        function B(b, a) {
            ...
            if (a.match(/^[^<]$/)) return a;
            CKEDITOR.env.webkit && -1 < a.indexOf("\x3cdiv\x3e") && (a = a.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "\x3cbr\x3e").replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "\x3cdiv\x3e\x3c/div\x3e"), a.match(/<div>(<br>|)<\/div>/) && (a = "\x3cp\x3e" + a.replace(/(<div>(<br>|)<\/div>)+/g,
            function(a) {
                return c(a.split("\x3c/div\x3e\x3cdiv\x3e").length + 1)
            }) + "\x3c/p\x3e"), a = a.replace(/<\/div><div>/g, "\x3cbr\x3e"), a = a.replace(/<\/?div>/g, ""));
            CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR && (CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "\x3cbr\x3e")), -1 < a.indexOf("\x3cbr\x3e\x3cbr\x3e") && (a = "\x3cp\x3e" + a.replace(/(<br>){2,}/g,
            function(a) {
                return c(a.length / 4)
            }) + "\x3c/p\x3e"));
            return C(b, a)
            ...
            init: function(b) {
                ...
                function(a) {
                    ...
                    if (!a.data.dataValue) {
                        ...
                        if (g) a.data.dataValue = g,
                        a.data.type = "html";
                        else if (g = c.getData("text/plain")) a.data.dataValue = b.editable().transformPlainTextToHtml(g),
                        a.data.type = "text"
                    }
                },
                null, null, 1);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function(b, a, c, d) {
                function e(b, c, d) {
                    ...
                    if (e.equals(c) && d != c.getChildCount()) return b = a.startContainer.getChild(a.startOffset - 1),
                    c = a.startContainer.getChild(a.startOffset),
                    b && b.type == CKEDITOR.NODE_TEXT && c && c.type == CKEDITOR.NODE_TEXT && (d = b.getLength(), b.setText(b.getText() + c.getText()), c.remove(), a.setStart(b, d), a.collapse(!0)),
                    !0
                }
            ...
            internalDrop: function(b, a, c, d) {
                ...
                CKEDITOR.env.ie && 10 > CKEDITOR.env.version && this.fixSplitNodesAfterDrop(b, a, e.dragStartContainerChildCount, e.dragEndContainerChildCount); (h = this.isDropRangeAffectedByDragRange(b, a)) || (f = b.createBookmark(!1));
            ...
            getRangeAtDropPosition: function(b, a) {
                ...
                if (document.caretRangeFromPoint) c = a.document.$.caretRangeFromPoint(d, e),
                f.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset),
                f.collapse(!0);
                else if (c.rangeParent) f.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset),
                f.collapse(!0);
                else {
        ...
        var f = CKEDITOR.addTemplate("panel", '\x3cdiv lang\x3d"{langCode}" id\x3d"{id}" dir\x3d{dir} class\x3d"cke cke_reset_all {editorId} cke_panel cke_panel {cls} cke_{dir}" style\x3d"z-index:{z-index}" role\x3d"presentation"\x3e{frame}\x3c/div\x3e'),
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                showBlock: function(a, b, c, l, h, g) {
                    ...
                    q = "rtl" == this._.dir,
                    d = t.x + (l || 0) - f.x,
                    n = t.y + (h || 0) - f.y; ! q || 1 != c && 4 != c ? q || 2 != c && 3 != c || (d += b.$.offsetWidth - 1) : d += b.$.offsetWidth;
                    ...
                    this), CKEDITOR.env.iOS && (e.on("touchstart",
                    function() {
                    ...
                    CKEDITOR.tools.setTimeout(function() {
                        var a = CKEDITOR.tools.bind(function() {
                            ...
                            var a = k.getFirst(),
                            f; (f = a.getCustomData("activePanel")) && f.onHide && f.onHide.call(this, 1);
                ...
                showAsChild: function(a, b, c, f, h, g) {
                    if (this._.activeChild != a || a._.panel._.offsetParentId != c.getId()) this.hideChild(),
    ...
    CKEDITOR.plugins.add("menu", {
        ...
        beforeInit: function(g) {
            for (var h = g.config.menu_groups.split(","), p = g._.menuGroups = {},
            n = g._.menuItems = {},
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function(a, b) {
                ...
                m = c.block.attributes = c.attributes || {}; ! m.role && (m.role = "menu");
            ...
            proto: {
                ...
                show: function(a, b, c, m) {
                    ...
                    for (var d = l.elementPath(), d = ['\x3cdiv class\x3d"cke_menu' + (d && d.direction() != l.lang.dir ? " cke_mixed_dir_content": "") + '" role\x3d"presentation"\x3e'], h = e.length, p = h && e[0].group, n = 0; n < h; n++) {
                        var q = e[n];
                        p != q.group && (d.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'), p = q.group);
                        q.render(this, n, d)
                    }
                    d.push("\x3c/div\x3e");
                    f.setHtml(d.join(""));
    ...
    CKEDITOR.plugins.add("resize", {
        init: function(b) {
            ...
            g = b.element ? b.element.getDirection(1) : "ltr"; ! a.resize_dir && (a.resize_dir = "vertical");
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                if (this.modes) {
                    ...
                    a.on("mode", c, this); ! this.readOnly && a.on("readOnly", c, this)
                } else g && (g = a.getCommand(g)) && (g.on("state",
                function() {
        ...
        function B(a) {
            function d() {
                for (var b = g(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || q(a), f = 0; f < e.length; f++) {
                    ...
                    if ("/" != l) {
                        ...
                        var m, d = l.groups;
                        if (d) for (var h = 0; h < d.length; h++) m = d[h],
                        (m = b[m]) && c(l, m); (m = b[l.name]) && c(l, m)
                    }
                }
                return e
            }
            ...
            function c(c, e) {
                if (e.length) {
                    ...
                    for (var f; f = e.shift();) f = "string" == typeof f ? f: f.name,
                    b && -1 != CKEDITOR.tools.indexOf(b, f) || (f = a.ui.create(f)) && a.addFeature(f) && c.items.push(f)
                }
            }
            function h(b) {
                var a = [],
            ...
            init: function(a) {
                ...
                function(c) {
                    if (c.data.space == a.config.toolbarLocation) {
                        ...
                        for (var r = a.toolbox.toolbars,
                        f = B(a), l = 0; l < f.length; l++) {
                            var m, n = 0,
                            v, p = f[l],
                            w;
                ...
                function() {
                    if (this.toolbox) {
                        var a, d = 0,
                        b, e, g;
                        for (a = this.toolbox.toolbars; d < a.length; d++) for (e = a[d].items, b = 0; b < e.length; b++) g = e[b],
    ...
    CKEDITOR.config.toolbarLocation = "top"; (function() {
        function q(a, d) {
            ...
            k = a._.elementsPath,
            q = k.idBase;
            d.html += '\x3cspan id\x3d"' + p + '_label" class\x3d"cke_voice_label"\x3e' + a.lang.elementspath.eleLabel + '\x3c/span\x3e\x3cspan id\x3d"' + p + '" class\x3d"cke_path" role\x3d"group" aria-labelledby\x3d"' + p + '_label"\x3e\x3cspan class\x3d"cke_path_empty"\x3e\x26nbsp;\x3c/span\x3e\x3c/span\x3e';
            a.on("uiReady",
            function() {
            ...
            w = CKEDITOR.tools.addFunction(function(c, e) {
                ...
                case b ? 39 : 37 : case 9:
                    return (b = CKEDITOR.document.getById(g + (c + 1))) || (b = CKEDITOR.document.getById(g + "0")),
                    b.focus(),
                    !1;
                case b ? 37 : 39 : case CKEDITOR.SHIFT + 9 : return (b = CKEDITOR.document.getById(g + (c - 1))) || (b = CKEDITOR.document.getById(g + (k.list.length - 1))),
                    b.focus(),
                    !1;
                case 27:
                    return a.focus(),
            ...
            function() {
                for (var c = [], e = k.list = [], g = [], b = k.filters, d = !0, l = a.elementPath().elements, f, u = l.length; u--;) {
                    var h = l[u],
                    r = 0;
                    f = h.data("cke-display-name") ? h.data("cke-display-name") : h.data("cke-real-element-type") ? h.data("cke-real-element-type") : h.getName(); (d = h.hasAttribute("contenteditable") ? "true" == h.getAttribute("contenteditable") : d) || h.hasAttribute("contenteditable") || (r = 1);
                ...
                e = e.length;
                for (b = 0; b < e; b++) f = g[b],
                d = a.lang.elementspath.eleTitle.replace(/%1/, f),
                f = x.output({
                    id: q + b,
                    label: d,
                    text: f,
                ...
                if (a = a || v(b)) {
                    ...
                    if (k = a.splitBlock(n)) {
                        ...
                        if (l || b) {
                            ...
                            e.is("li") && e.removeAttribute("value"); ! CKEDITOR.env.ie || !l || b && d.getChildCount() || (a.moveToElementEditStart(b ? d: e), a.select());
        ...
        function k(b, f) {
            ...
            b = b.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g,
            function(b, a) {
                var d = f ? "\x26" + a + ";": e[a];
                g[d] = f ? e[a] : "\x26" + a + ";";
                c.push(d);
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function(b) {
                ...
                if (b = (b = b.dataProcessor) && b.htmlFilter) {
                    var e = []; ! 1 !== c.basicEntities && e.push("nbsp,gt,lt,amp");
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        ...
        function q(a, c) {
            ...
            if ("function" != typeof c || !1 !== c.call(this._.filebrowserSe)) if (!e || !1 !== e.call(this._.filebrowserSe, a, c)) if ("string" == typeof c && c && alert(c), a && (b = this._.filebrowserSe, d = b.getDialog(), b = b.filebrowser.target || null)) if (b = b.split(":"), e = d.getContentElement(b[0], b[1])) e.setValue(a),
            d.selectPage(b[0])
        }
        ...
        function(a) {
            ...
            d, b = 0; b < c.contents.length; ++b) if (d = c.contents[b]) l(a.editor, a.data.name, c, d.elements),
    ...
    CKEDITOR.plugins.add("format", {
        ...
        init: function(a) {
            if (!a.blockless) {
                for (var f = a.config,
                c = a.lang.format,
                l = f.format_tags.split(";"), d = {},
                m = 0, n = [], g = 0; g < l.length; g++) {
                    var h = l[g],
    ...
    CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
        ...
        function m(a) {
            ...
            } catch(h) {} (CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == b.document.$.compatMode) && this.attachListener(this, "keydown",
            function(a) {
            ...
            CKEDITOR.env.ie && this.attachListener(c, "blur",
            function() {
                try {
                    c.$.selection.empty()
                } catch(a) {}
            });
            CKEDITOR.env.iOS && this.attachListener(c, "touchend",
            function() {
                a.focus()
            });
        ...
        CKEDITOR.plugins.add("image", {
            ...
            init: function(b) {
                if (!b.plugins.image2) {
                    ...
                    b.on("doubleclick",
                    function(b) {
                        var a = b.data.element; ! a.is("img") || a.data("cke-realelement") || a.isReadOnly() || (b.data.dialog = "image")
                    });
    ...
    CKEDITOR.config.image_removeLinkByEmptyURL = !0; (function() {
        ...
        CKEDITOR.plugins.add("indent", {
            init: function(a) {
                ...
                function(b) {
                    ...
                    f.setStartBefore(l);
                    f.setEndAfter(l);
                    for (var n = new CKEDITOR.dom.walker(f), c; c = n.next();) if (c.type == CKEDITOR.NODE_ELEMENT) if (!c.equals(l) && c.getDirection()) f.setStartAfter(c),
                    n = new CKEDITOR.dom.walker(f);
                    else {
        ...
        function w(c) {
            function f(b) {
                for (var e = d.startContainer,
                a = d.endContainer; e && !e.getParent().equals(b);) e = e.getParent();
                for (; a && !a.getParent().equals(b);) a = a.getParent();
                if (!e || !a) return ! 1;
                for (var g = e,
                e = [], k = !1; ! k;) g.equals(a) && (k = !0),
                e.push(g),
                g = g.getNext();
                ...
                if (r && r.length) for (a = 0; a < r.length; a++) {
                    for (m = b = r[a]; (m = m.getNext()) && m.is && m.getName() in p;) CKEDITOR.env.needsNbspFiller && !b.getFirst(x) && b.append(d.document.createText(" ")),
                    b.append(m);
                    b.insertAfter(f)
                }
            ...
            q = this.database,
            p = this.context,
            n = c.getSelection(), n = (n && n.getRanges()).createIterator(), d; d = n.getNextRange();) {
                ...
                function f(c) {
                    ...
                    function(f) {
                        if ("wysiwyg" == c.mode && f.data.keyCode == this.indentKey) {
                            var n = this.getContext(c.elementPath()); ! n || this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c.elementPath(), n) || (c.execCommand(this.relatedGlobal), f.cancel())
                        }
                    },
                    this);
        ...
        CKEDITOR.plugins.add("fakeobjects", {
            ...
            afterInit: function(a) { (a = (a = a.dataProcessor) && a.htmlFilter) && a.addRules(m, {
                    applyToAll: !0
                })
            }
        });
        ...
        CKEDITOR.plugins.link = {
            ...
            parseLinkAttributes: function(c, b) {
                ...
                d,
                g = {};
                a.match(t) && ("encode" == e ? a = a.replace(A,
                function(a, b, c) {
                    c = c || "";
                ...
                function(a, b, c) {
                    if (b == f.name) {
                        ...
                        c = c.match(/[^,\s]+/g);
                        for (var d = c.length,
                        e, h, k = 0; k < d; k++) e = decodeURIComponent,
                ...
                if (!g.type) if (e = a.match(x)) g.type = "anchor",
                g.anchor = {},
                ...
                } else a && (d = a.match(y)) && (g.type = "url", g.url = {},
                g.url.protocol = d[1], g.url.url = d[2]);
                if (b) {
        ...
        function I(b, m, e) {
            ...
            h = null;
            for (k = 0; k < g.length; k++) h = g[k].getCustomData("listarray_index"),
            f[h].indent = -1;
            for (k = h + 1; k < f.length; k++) if (f[k].indent > f[k - 1].indent + 1) {
                g = f[k - 1].indent + 1 - f[k].indent;
                for (h = f[k].indent; f[k] && f[k].indent >= h;) f[k].indent += g,
                k++;
                k--
            }
        ...
        function E(b, m, e, c) {
            for (var f, g; f = b[c ? "getLast": "getFirst"](J);)(g = f.getDirection(1)) !== m.getDirection(1) && f.setAttribute("dir", g),
            f.remove(),
        ...
        function C(b, m, e) {
            ...
            k ? (k = k.getBogus()) && k.remove() : h && (k = h.getPrevious(u)) && z(k) && k.remove(); (k = c.getLast()) && k.type == CKEDITOR.NODE_ELEMENT && k.is("br") && k.remove(); (k = m.startContainer.getChild(m.startOffset)) ? c.insertBefore(k) : m.startContainer.append(c);
            ...
            listToArray: function(b, m, e, c, f) {
                ...
                k = b.getChildCount(); g < k; g++) {
                    ...
                    if ("li" == h.$.nodeName.toLowerCase()) {
                        ...
                        e.push(d);
                        for (var a = 0,
                        p = h.getChildCount(), l; a < p; a++) l = h.getChild(a),
                        l.type == CKEDITOR.NODE_ELEMENT && v[l.getName()] ? CKEDITOR.plugins.list.listToArray(l, m, e, c + 1, d.grandparent) : d.contents.push(l)
                    }
                }
                return e
            },
            arrayToList: function(b, m, e, c, f) {
                ...
                for (var g, k = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(k), d = null, a = e, p = Math.max(b[e].indent, 0), l = null, q, n, t = c == CKEDITOR.ENTER_P ? "p": "div";;) {
                    ...
                    if (r.indent == p) {
                        ...
                        a++
                    } else if (r.indent == Math.max(p, 0) + 1) r = b[a - 1].element.getDirection(1),
                    a = CKEDITOR.plugins.list.arrayToList(b, null, a, c, r != q ? q: null),
                    !l.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= k.$.documentMode && l.append(k.createText(" ")),
                    l.append(a.listNode),
                    a = a.nextIndex;
        ...
        B.prototype = {
            exec: function(b) {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    ...
                    } else m.enterMode == CKEDITOR.ENTER_BR ? f.appendBogus() : c[0].fixBlock(1, m.enterMode == CKEDITOR.ENTER_P ? "p": "div"),
                    e.selectRanges(c)
                }
                for (var m = e.createBookmarks(!0), f = [], k = {},
                c = c.createIterator(), h = 0; (g = c.getNextRange()) && ++h;) {
                    ...
                    for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; d = g.getNextParagraph();) if (!d.getCustomData("list_block")) {
                        ...
                        for (var l = b.elementPath(d), a = l.elements, p = 0, l = l.blockLimit, q, n = a.length - 1; 0 <= n && (q = a[n]); n--) if (v[q.getName()] && l.contains(q)) {
                            l.removeCustomData("list_group_object_" + h); (a = q.getCustomData("list_group_object")) ? a.contents.push(d) : (a = {
                                root: q,
                                contents: [d]
                            },
                ...
                for (q = []; 0 < f.length;) if (a = f.shift(), this.state == CKEDITOR.TRISTATE_OFF) if (v[a.root.getName()]) {
                    ...
                    l = [];
                    for (d = 0; d < h.contents.length; d++) n = h.contents[d],
                    (n = n.getAscendant("li", !0)) && !n.getCustomData("list_item_processed") && (l.push(n), CKEDITOR.dom.element.setMarker(a, n, "list_item_processed", !0));
                    ...
                    if (! (1 > h.length)) {
                        ...
                        d.push(n);
                        for (t = d = void 0; h.length;) d = h.shift(),
                        t = c.createElement("li"),
                        r = d,
                        r.is("pre") || L.test(r.getName()) || "false" == r.getAttribute("contenteditable") ? d.appendTo(t) : (d.copyAttributes(t), a && d.getDirection() && (t.removeStyle("direction"), t.removeAttribute("dir")), d.moveChildren(t), d.remove()),
                        t.appendTo(n);
                ...
                function(m) {
                    ...
                    if ("wysiwyg" == b.mode && e in {
                        ...
                        if (f && f.collapsed) {
                            ...
                            if (k) {
                                ...
                                if (d.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), k = (h = c.getLast(u)) && G(h) ? h: c, g = 0, (a = d.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.getName() in v && a.equals(h) ? (g = 1, a = d.next()) : f.checkBoundaryOfElement(k, CKEDITOR.END) && (g = 2), g && a) {
                                    ...
                                    if (1 == g && (e.optimize(), !e.startContainer.equals(c))) {
                                        for (c = e.startContainer; c.is(CKEDITOR.dtd.$inline);) p = c,
                                        c = c.getParent();
                            ...
                            } else d.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END),
                            (a = d.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.is(v) && (a = a.getFirst(u), g.block && f.checkStartOfBlock() && f.checkEndOfBlock() ? (g.block.remove(), f.moveToElementEditStart(a), f.select()) : A(a) ? (f.moveToElementEditStart(a), f.select()) : (f = f.clone(), f.moveToElementEditStart(a), C(b, e, f)), m.cancel());
                            setTimeout(function() {
                                b.selectionChange(1)
                            })
                        }
            ...
            return {
                ...
                exec: function() {
                    ...
                    return function(b) {
                        ...
                        if (!aa(a, b) && b && !b.equals(a.editable) && !b.contains(a.editable)) { (e = P(b)) && "false" == e.getAttribute("contenteditable") && (b = e);
                            a.element = b;
                            e = w(a, b, !c);
                            var f;
        ...
        function ea(a) {
            ...
            } else e.equals(a.editable[h ? "getLast": "getFirst"](a.isRelevant)) ? (H(a), h && q(c.y, e.size.bottom - b, d.pane.height) && q(e.size.bottom, d.pane.height - b, d.pane.height) ? k = D: q(c.y, 0, e.size.top + b) && (k = C)) : k = x,
            f = [null, e][h ? "reverse": "concat"]().concat([h ? da: I, M, k, e.equals(a.editable[h ? "getLast": "getFirst"](a.isRelevant)) ? h ? D: C: x]);
            return 0 in f ? new z(f) : null
        }
        function U(a, c, d, b) {
            for (var e = c.getDocumentPosition(), f = {},
            k = {},
            h = {},
            g = {},
            l = y.length; l--;) f[y[l]] = parseInt(c.getComputedStyle.call(c, "border-" + y[l] + "-width"), 10) || 0,
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function(a) {
                ...
                function() {
                    ...
                    null, null, 0), d.attachListener(b.inInlineMode ? g: g.getWindow().getFrame(), "mouseout",
                    function(c) {
                    ...
                    }), d.attachListener(l, "scroll",
                    function() {
                        "wysiwyg" == a.mode && (b.line.detach(), t.webkit && (b.hiddenMode = 1, clearTimeout(e), e = setTimeout(function() {
                            b.mouseDown || (b.hiddenMode = 0)
                        },
                        50)))
                    }), d.attachListener(ja ? g: l, "mousedown",
                    function() {
                        "wysiwyg" == a.mode && (b.line.detach(), b.hiddenMode = 1, b.mouseDown = 1)
                    }), d.attachListener(ja ? g: l, "mouseup",
                    function() {
                        b.hiddenMode = 0;
                        b.mouseDown = 0
                    }), a.addCommand("accessPreviousSpace", Y(b)), a.addCommand("accessNextSpace", Y(b, !0)), a.setKeystroke([[c.magicline_keystrokePrevious, "accessPreviousSpace"], [c.magicline_keystrokeNext, "accessNextSpace"]]), a.on("loadSnapshot",
                    function() {
                        var c, d, e, f;
                        for (f in {
                            p: 1,
        ...
        ia = function() {
            function a(a) {
                ...
                h, g, l, p; f && !f.equals(e) && (g = e.getNext(a.isRelevant));) h = Math.abs(ka(a, e, g) - a.mouse.y),
                h < b && (b = h, l = e, p = g),
                e = g,
                r(a, e);
                    ...
                    a.addCommand("maximize", {
                        ...
                        exec: function() {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                for (d = a.container; d = d.getParent();) d.setCustomData("maximize_saved_styles", r(d)),
                                ...
                                b.getDocumentElement().setStyles(g); ! CKEDITOR.env.gecko && b.getDocumentElement().setStyle("position", "fixed");
                                ...
                                for (var d = [g, h], q = 0; q < d.length; q++) u(d[q], d[q].getCustomData("maximize_saved_styles")),
                                d[q].removeCustomData("maximize_saved_styles");
                                for (d = a.container; d = d.getParent();) u(d, d.getCustomData("maximize_saved_styles")),
                            ...
                            this.toggleState();
                            if (d = this.uiItems[0]) g = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize: f.maximize.minimize,
                ...
                exec: function(a) {
                    ...
                    c; c = n.getNextRange();) {
                        ...
                        if (d) for (k(d), b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); b && !b.equals(d);) if (b.isReadOnly()) {
                            ...
                            b = b.getNext(p)
                        } else k = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT),
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        addMenuItems: function(a) {
            ...
            a.plugins.wsc && (b.WSC = {
                ...
                onClick: function() {
                    ...
                    d = a.scayt,
                    c = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.container.getText() : a.document.getBody().getText(); (c = c.replace(/\s/g, "")) ? (d && b.state.scayt[a.name] && d.setMarkupPaused && d.setMarkupPaused(!0), a.lockSelection(), a.execCommand("checkspell")) : alert("Nothing to check!")
                }
            });
            a.addMenuItems(b)
        },
            ...
            f = function() {
                ...
                function(b) {
                    ...
                    if ((d || b) && a._.savedSelection) {
                        ...
                        for (var f = 0; f < b.length; f++) h = b[f],
                        "string" === typeof h.startContainer.$.nodeValue && (c = h.startContainer.getText().length, (c < h.startOffset || c < h.endOffset) && a.unlockSelection(!1))
                    }
                },
                this, null, -10)
            },
            g = function() {
                d ? a.config.scayt_inlineModeImmediateMarkup ? e() : (a.on("blur",
                function() {
                    setTimeout(b, 0)
        ...
        buildSuggestionMenuItems: function(a, c, d) {
            ...
            } else for (d = 0; d < c.length; d++) k = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[d].replace(" ", "_"),
            a.addCommand(k, this.createCommand(CKEDITOR.plugins.scayt.suggestions[d], f, g)),
            a.addMenuItem(k, {
                label: c[d],
                command: k,
    ...
    CKEDITOR.plugins.scayt = {
        ...
        createScayt: function(a) {
            ...
            function(a) {
                ...
                function() {},
                function() {}), e.subscribe("suggestionListSend",
                function(a) {
                    for (var b = {},
                    d = [], c = 0; c < a.suggestionList.length; c++) b["word_" + a.suggestionList[c]] || (b["word_" + a.suggestionList[c]] = a.suggestionList[c], d.push(a.suggestionList[c]));
                    CKEDITOR.plugins.scayt.suggestions = d
                }), e.subscribe("selectionIsChanged",
                function(d) {
                    a.getSelection().isLocked && a.lockSelection()
                }), e.subscribe("graytStateChanged",
                function(c) {
        ...
        loadScaytLibrary: function(a, c) {
            var d = this,
            b, e;
            this.loadingHelper[a.name] || ("undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (this.loadingHelper[a.name] = c, this.loadingHelper.loadOrder.push(a.name), b = new Date, b = b.getTime(), e = a.config.scayt_srcUrl, e += 0 <= e.indexOf("?") ? "": "?" + b, this.loadingHelper.ckscaytLoading || (CKEDITOR.scriptLoader.load(e,
            function(a) {
                if (a) {
    ...
    function() {
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[c] = CKEDITOR.tools.override(a[c],
            function(a) {
                return function(b) {
        ...
        CKEDITOR.plugins.add("stylescombo", {
            ...
            init: function(c) {
                ...
                function(b) {
                    if (b = b.data.styles) {
                        for (var a, h, d, e = 0,
                        n = b.length; e < n; e++)(a = b[e], c.blockless && a.element in CKEDITOR.dtd.$block || (h = a.name, a = new CKEDITOR.style(a), c.filter.customConfig && !c.filter.check(a))) || (a._name = h, a._.enterMode = l.enterMode, a._.type = d = a.assignedTo || a.type, a._.weight = e + 1E3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3), f[h] = a, k.push(a), m.push(a));
                        k.sort(function(a, b) {
                ...
                exec: function(d) {
                    if (d.editable().hasFocus) {
                        ...
                        1)) {
                            ...
                            if (a || c) if (a) a = new CKEDITOR.dom.element(a),
    ...
    CKEDITOR.plugins.add("table", {
        ...
        function v(e, d) {
            for (var b = d ? Infinity: 0, c = 0; c < e.length; c++) {
                ...
                a = e[c];
                for (var f = d,
                g = a.getParent().$.cells, h = 0, k = 0; k < g.length; k++) {
                    var l = g[k],
                    h = h + (f ? 1 : l.colSpan);
                    if (l == a.$) break
                }
        ...
        function m(e, d) {
            for (var b = t(e), c = b[0].getAscendant("table"), a = v(b, 1), b = v(b), a = d ? a: b, f = CKEDITOR.tools.buildTableMap(c), c = [], b = [], g = f.length, h = 0; h < g; h++) c.push(f[h][a]),
            ...
            init: function(e) {
                ...
                b("columnDelete", d({
                    ...
                    exec: function(a) {
                        ...
                        for (var d = CKEDITOR.tools.buildTableMap(a), e, l, n = [], r = 0, p = d.length; r < p; r++) for (var m = 0,
                        u = d[r].length; m < u; m++) d[r][m] == b.$ && (e = m),
                        d[r][m] == c.$ && (l = m);
                        for (r = e; r <= l; r++) for (m = 0; m < d.length; m++) c = d[m],
    ...
    CKEDITOR.tools.buildTableMap = function(t) {
        ...
        k.prototype = {
            onKeydown: function(a) {
                ...
                else if (this.keyEventsStack.cleanUp(a), a = this.undoManager, this.keyEventsStack.getLast(b) || this.keyEventsStack.push(b), this.lastKeydownImage = new f(a.editor), e.isNavigationKey(b) || this.undoManager.keyGroupChanged(b)) if (a.strokesRecorded[0] || a.strokesRecorded[1]) a.save(!1, this.lastKeydownImage, !1),
                a.resetType()
            },
            onInput: function() {
